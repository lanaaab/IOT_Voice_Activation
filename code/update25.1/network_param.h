...
// const char *ssid = "Ananap";
// const char *password = "anan1234";
const char *ssid = "Lana";
const char *password = "onemillion";
...
const char* time_zone = "IST-2IDT,M3.5.0/3,M10.5.0/4";  // TimeZone rule for Israel
